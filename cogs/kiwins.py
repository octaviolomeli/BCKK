...
class Kiwins(commands.Cog):
  ...
  async def on_ready(self):
      print('Kiwins file is ready.')
      
  # sends the information of a person
  @commands.command()
  async def khours(self, ctx, *, name='Octavio Lomeli-Castro'):
  ...
  @commands.command()
  async def kattended(self, ctx, *,member='Octavio Lomeli-Castro'):
